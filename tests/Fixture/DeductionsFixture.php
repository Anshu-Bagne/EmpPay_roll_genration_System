...
class DeductionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_deduction_payslip' => ['type' => 'index', 'columns' => ['payslip_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_deduction_payslip' => ['type' => 'foreign', 'columns' => ['payslip_id'], 'references' => ['payslips', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2026-07-11 11:23:48',
                'modified' => '2026-07-11 11:23:48',
            ],
        ];
        parent::init();
    }
